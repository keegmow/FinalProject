...
<link href="resources/Cover Template for Bootstrap_files/cover.css"
	rel="stylesheet">
						...
						<c:forEach var="i" items="${results}">
							<div class="panel panel-default">
								<div class="panel-heading">
										...
										<b><a href="<c:out value="${i.getURL()}"/>">
										<c:out value="${i.getTitle()}" /></a> 
										</b>
									
									<br>
									<div class="panel-body">
									<c:out value="${i.getStartTime()}" />
									<br>
									<c:out value="${i.getVenue().getName()}" />
									<br>
									</div>
								</div>
							</div>
